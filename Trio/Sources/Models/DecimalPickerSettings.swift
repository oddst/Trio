...
struct DecimalPickerSettings {
    ...
    var maxIOB = PickerSetting(value: 0, step: 1, min: 0, max: 100, type: PickerSetting.PickerSettingType.insulinUnit)
    ...
    var maxSMBBasalMinutes = PickerSetting(value: 30, step: 5, min: 30, max: 300, type: PickerSetting.PickerSettingType.minute)
    var maxUAMSMBBasalMinutes = PickerSetting(value: 30, step: 5, min: 30, max: 300, type: PickerSetting.PickerSettingType.minute)
